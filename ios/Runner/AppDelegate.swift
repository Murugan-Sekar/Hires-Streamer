...
@objc class AppDelegate: FlutterAppDelegate {
    private let CHANNEL = "com.peter.hirresstreamer/backend"
    private let DOWNLOAD_PROGRESS_STREAM_CHANNEL = "com.peter.hirresstreamer/download_progress_stream"
    private let LIBRARY_SCAN_PROGRESS_STREAM_CHANNEL = "com.peter.hirresstreamer/library_scan_progress_stream"
    private let streamQueue = DispatchQueue(label: "com.peter.hirresstreamer.progress_stream", qos: .utility)
